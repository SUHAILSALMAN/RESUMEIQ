...
export type AnalysisResult = {
  ...
  role_prediction?: {
    ...
    missing_skills: string[]
    reason: string
    alternatives: { job_title: string; match_percentage: number; matched_count: number; required_count: number }[]
    selected_job_title: string
    selected_match_percentage: number
    classifier_label: string | null
    classifier_confidence: number | null
    classifier_mapped_roles: string[]
  }
  related_roles?: { job_title: string; match_percentage: number; matched_count: number; required_count: number }[]
