    ...
    <div>
      <div className="mb-10">
        ...
        <p style={{ color: 'var(--muted-foreground)', fontWeight: 300 }}>
          Track career readiness and run skill matches against 324 job roles.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-0 mb-10" style={{ border: '1px solid var(--border)' }}>
        {[
          { label: 'Analyses run', value: String(items.length) },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
        <div className="p-8" style={{ border: '1px solid var(--border)', background: 'var(--card)' }}>
          ...
          <p className="mb-6 text-sm leading-relaxed" style={{ color: 'rgba(245,240,232,0.55)', fontWeight: 300 }}>
            Upload a PDF or DOCX resume, choose a target role, and get TF-IDF / embedding scores, skill gaps, and readiness level from the live analysis pipeline.
          </p>
          <Link
            to="/analyze"
        ...
        <div className="p-8" style={{ border: '1px solid var(--border)' }}>
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              'TF-IDF · Doc2Vec · Sentence-Transformers',
              'SMOTE-balanced category classifier',
      ...
      <div>
        ...
        {items.length === 0 ? (
          <div className="p-8 text-sm" style={{ border: '1px solid var(--border)', color: 'var(--muted-foreground)' }}>
            No analyses yet. Run your first skill match to populate this feed.
          </div>
        ) : (
